neg5 = ['bastard','bastards','bitch','bitches','cock','cocksucker','cocksuckers','cunt',
'motherfucker','motherfucking','niggas','nigger','prick','slut','son-of-a-bitch','twat'];

neg4 = ['ass','assfucking','asshole','bullshit','catastrophic','damn','damned','damnit','dick',
...
neg3 = ['abhor','abhorred','abhorrent','abhors','abuse','abused','abuses','abusive',
...
neg2 = ['abandon','abandoned','abandons','abducted','abduction','abductions','accident',
...
neg1 = ['absentee','absentees','admit','admits','admitted','affected','afflicted','affronted',
